...
# 创建多平台 Manifests
docker manifest create ps-docker-registry.cn-beijing.cr.aliyuncs.com/psdsframework/uniapp_template:$1 \
    ps-docker-registry.cn-beijing.cr.aliyuncs.com/psdsframework/uniapp_template:$1-arm64v8 \
    ps-docker-registry.cn-beijing.cr.aliyuncs.com/psdsframework/uniapp_template:$1-x86_64
# 设置 Manifests 中的平台信息
docker manifest annotate ps-docker-registry.cn-beijing.cr.aliyuncs.com/psdsframework/uniapp_template:$1 \
    ps-docker-registry.cn-beijing.cr.aliyuncs.com/psdsframework/uniapp_template:$1-arm64v8 --os linux --arch arm64 --variant v8
docker manifest annotate ps-docker-registry.cn-beijing.cr.aliyuncs.com/psdsframework/uniapp_template:$1 \
    ps-docker-registry.cn-beijing.cr.aliyuncs.com/psdsframework/uniapp_template:$1-x86_64 --os linux --arch amd64
# 推送多平台 Manifests 到 Docker 镜像仓库
docker manifest push ps-docker-registry.cn-beijing.cr.aliyuncs.com/psdsframework/uniapp_template:$1
echo ps-docker-registry.cn-beijing.cr.aliyuncs.com/psdsframework/uniapp_template:$1